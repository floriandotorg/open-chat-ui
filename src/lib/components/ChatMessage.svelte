    ...
    <div class="flex max-w-[80%] gap-3 min-w-0">
      ...
      <div class="min-w-0">
        ...
        <div class="mt-1 flex items-center gap-0.5">
          ...
          <button onclick={() => onregenerate?.(message.id)} class="cursor-pointer rounded p-0.5 text-gray-400 hover:text-gray-600 dark:text-neutral-500 dark:hover:text-neutral-300" aria-label="Regenerate message">
